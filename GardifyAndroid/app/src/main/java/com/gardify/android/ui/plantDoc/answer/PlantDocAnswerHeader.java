...
public class PlantDocAnswerHeader extends LinearLayout implements RecycleViewGenericAdapter.RecyclerViewRowHeader<PlanDocViewModelAnswer> {
    ...
    public PlantDocAnswerHeader(Context context) {
        super(context);
    }

    public PlantDocAnswerHeader(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public PlantDocAnswerHeader(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onFinishInflate() {
        ...
        imageView = findViewById(R.id.imageView_plant_doc_answer_plant_item_plant_image);
        textViewHeader = findViewById(R.id.textView_plant_doc_answer_row_item_header);
        textViewDate = findViewById(R.id.textView_plant_doc_answer_row_item_date);
        textViewQuestion = findViewById(R.id.textView_plant_doc_answer_row_item_question1);
        imageViewButton = findViewById(R.id.imageView_plant_doc_answer_row_item_button);
    }
