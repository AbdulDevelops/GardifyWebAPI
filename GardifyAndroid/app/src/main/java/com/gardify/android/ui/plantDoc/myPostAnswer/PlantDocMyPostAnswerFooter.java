...
public class PlantDocMyPostAnswerFooter extends LinearLayout implements RecycleViewGenericAdapter.RecyclerViewRowFooter<PlanDocViewModelAnswer> {
    ...
    public PlantDocMyPostAnswerFooter(Context context) {
        super(context);
    }

    public PlantDocMyPostAnswerFooter(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public PlantDocMyPostAnswerFooter(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onFinishInflate() {
        ...
        buttonAnswer = findViewById(R.id.button_plant_doc_my_post_answer_footer_answer);
        textViewAnswer = findViewById(R.id.textView_plant_doc_my_post_answer_footer_answer);
        editTextAnswer = findViewById(R.id.button_plant_doc_my_post_answer_footer_answer_text);
        buttonSendAnswer = findViewById(R.id.button_plant_doc_my_post_answer_footer_send_answer);
