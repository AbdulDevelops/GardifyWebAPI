...
//  GardifyIOS
//
//  Created by Team Netzlab on 26.08.20.
...
struct Device {
    ...
    static let IS_IPHONE_12             = IS_IPHONE && SCREEN_MAX_LENGTH == 844 // 12, 12 Prop
    static let IS_IPHONE_12_MAX         = IS_IPHONE && SCREEN_MAX_LENGTH == 926 // 12 Pro Max
