...
namespace GardifyNewsletter.Migrations
{
    ...
    [Migration("20201122232510_AddedSubComponentModel")]
    partial class AddedSubComponentModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GardifyNewsletter.Models.NewsletterSubComponents", b =>
                {
                    b.Property<int>("NewsletterSubComponentId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int?>("NewPlantArticleId");

                    b.Property<int?>("NewsletterComponentTemplateId");

                    b.Property<int?>("newsletterComponentsNewsletterComponentId");

                    b.HasKey("NewsletterSubComponentId");

                    b.HasIndex("newsletterComponentsNewsletterComponentId");

                    b.ToTable("NewsletterSubComponents");
                });
            ...
            modelBuilder.Entity("GardifyNewsletter.Models.NewsletterSubComponents", b =>
                {
                    b.HasOne("GardifyNewsletter.Models.NewsletterComponents", "newsletterComponents")
                        .WithMany("newsletterSubComponents")
                        .HasForeignKey("newsletterComponentsNewsletterComponentId");
                });
