...
namespace GardifyWebAPI.Controllers
{
    ...
    public class AccountController : ApiController 
    {
        ...
        private _BaseController baseController = new _BaseController();
        ...
        //[Route("UserInfo")]
        //public GardifyModels.Models.UserInfoViewModel GetUserInfo()
        //{
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            if (error != null)
            {
                return Redirect(Utilities.GetAbsolutePath("~/") + "#error=" + Uri.EscapeDataString(error));
            }
        ...
        public void UploadProfilImage(HttpPostedFileBase imageFile, HttpPostedFile imageFileSrc, int userPropertyId, string imageTitle = null, string imageDescription = null)
        {
            ...
            else
            {
                ...
                string relativePath = System.Web.Hosting.HostingEnvironment.MapPath("~/nfiles/UserProfilImages/");
                ...
                baseController.UploadAndRegisterFileFull(imageFile, userPropertyId, (int)ModelEnums.ReferenceToModelClass.UserProfil, ModelEnums.FileReferenceType.UserProfileImage, imageTitle, imageDescription);
            }
