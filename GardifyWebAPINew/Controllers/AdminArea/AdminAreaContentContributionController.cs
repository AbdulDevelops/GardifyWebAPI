...
namespace GardifyWebAPI.Controllers.AdminArea
{
    public class AdminAreaContentContributionController : _BaseController
    {
        ...
        public ActionResult Edit(SynonymViewModels.SynonymEditViewModel editView)
        {
            ...
            {
                throw new Exception("Das übergebene Model ist nicht korrekt");//, HttpStatusCode.InternalServerError, "AdminAreaContentContributionController.Edit("+editView.Text+")"); 
            }
        }
        ...
        public ActionResult Delete(SynonymViewModels.SynonymDeleteViewModel dvm)
        {
            ...
            {
                throw new Exception("Das übergebene Model ist nicht korrekt");//, HttpStatusCode.InternalServerError, "AdminAreaContentContributionController.Delete("+dvm.Text+")");
            }
        }
        ...
        {
            var synonyms = (from syn in plantDB.Synonym
        ...
        {
            var dbSynonym = (from syn in plantDB.Synonym
        ...
        {
            var synonyms = (from db in plantDB.Synonym
        ...
        {
            var synonym = (from db in plantDB.Synonym
                           where db.Id == id
