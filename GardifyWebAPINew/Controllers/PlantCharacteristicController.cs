...
namespace GardifyWebAPI.Controllers
{
    public class PlantCharacteristicController : _BaseController
    {
        ...
        public bool DbCreatePlantCharacteristic(PlantCharacteristic newCharacteristicData, bool overwriteDuplicate = true)
        {
            ...
            {
                var charac_sel = (from charac in plantDB.PlantCharacteristic.Where(d => !d.Deleted)
                ...
                else
                {
                    ...
                    plantDB.PlantCharacteristic.Add(newCharacteristicData);
                }
        ...
        {
            var cat_sel = (from c in plantDB.PlantCharacteristic
        ...
        [NonAction]
        public IEnumerable<PlantCharacteristic> DbGetPlantCharacteristics()
        {
            return plantDB.PlantCharacteristic.Where(p => !p.Deleted).Include(p => p.Category);
        }
        ...
        public IEnumerable<PlantCharacteristic> DbGetPlantCharacteristicsByPlantId(int plantId)
        {
           ...
           return (from c in plantDB.PlantCharacteristic
        ...
        {
            var charac_sel = (from charac in plantDB.PlantCharacteristic
            ...
            if (charac_sel != null && charac_sel.Any())
            {
                ...
                plantDB.Entry(original).State = EntityState.Modified;
                return plantDB.SaveChanges() > 0 ? true : false;
            }
            else
            {
        ...
        //{
        //    var checkPlant_sel = (from p in plantDB.Plant
        ...
        public bool DbDeletePlantCharacteristic(int id, string deletedBy)
        {
            ...
            if (charac_sel != null)
            {
                ...
                plantDB.Entry(charac_sel).State = EntityState.Modified;
                return plantDB.SaveChanges() > 0 ? true : false;
            }
            else
            {
