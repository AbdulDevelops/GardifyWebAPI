...
namespace PflanzenApp.Controllers
{
    ...
    public class AccountController : _BaseController
    {
        ...
        private static void MyTaskAsMethod(CancellationToken cancellationToken)
        {
            ...
            var deletedUserList = userList.Where(u => !u.EmailConfirmed && u.RegisterDate < today);
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public ActionResult Beta(LoginViewModel model, string returnUrl)
        {

            BetaKeyController bkc = new BetaKeyController();
            model.beta = false;
            model.notification = true;
            bkc.DbAddBetaMember(model);
            ViewBag.Notification = "Erfolgreich Eingetragen.";
        ...
        public async Task<ActionResult> VerifyCode(string provider, string returnUrl, bool rememberMe)
        {
            ...
            {
                return RedirectToError("Sie müssen angemeldet sein, um diese Aktion durchzuführen.", System.Net.HttpStatusCode.Unauthorized, "AccountController.VerifyCode("+provider +"," + returnUrl +"," + rememberMe + ")");
            }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            {
                BetaKeyController bkc = new BetaKeyController();
                if (bkc.DbCheckBetaKey(model.BetaKey))
                {
        ...
        public async Task<ActionResult> ConfirmEmail(string userId, string code)
        {
            ...
            {
                RedirectToError("Sie müssen angemeldet sein, oder einen gültigen Code angeben, um Ihre E-Mail zu bestätigen.", HttpStatusCode.Unauthorized, "AccountController.ConfirmEmail("+userId +"," + code+")");
            }
        ...
        public ActionResult ResetPassword(string code)
        {
            ...
            {
                return RedirectToError("Der Sicherheitscode darf nicht leer sein.", HttpStatusCode.Unauthorized, "AccountController.RessetPassword("+code+")");
            }
            else
            {
                return View();
        ...
        public async Task<ActionResult> SendCode(string returnUrl, bool rememberMe)
        {
            ...
            if (userId == null)
            {
                return RedirectToError("Sie müssen angemeldet sein, um diese Aktion durchzuführen", HttpStatusCode.Unauthorized, "AccountController.SendCode("+Url+","+ rememberMe+")");
            }
        ...
        public async Task<ActionResult> SendCode(SendCodeViewModel model)
        {
            ...
            {
                return RedirectToError("Beim Senden des Codes ist etwas schief gegangen", HttpStatusCode.InternalServerError, "AccountController.SendCode("+model.ToString()+")");
            }
