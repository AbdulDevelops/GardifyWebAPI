...
namespace PflanzenApp.Controllers.AdminArea
{
    ...
    public class AdminAreaUtilsController : Controller
    {
        ...
        {
            GardifyModels.Models.AdminAreaViewModels.UtilsViewModel utilsViewModel = new AdminAreaViewModels.UtilsViewModel();
        ...
        // POST: intern/utils/migrate-ctx
        [HttpPost]
        [ActionName("migrate-ctx")]
        [ValidateAntiForgeryToken]
        public ActionResult MigrateDb()
        {

            AdminAreaViewModels.UtilsViewModel.Message statusMessage = new AdminAreaViewModels.UtilsViewModel.Message("nothing happens");
        ...
        [ValidateAntiForgeryToken]
        public ActionResult changeCustomSettings(AdminAreaViewModels.UtilsViewModel utilsViewModel)
        {
        ...
        [ValidateAntiForgeryToken]
        public ActionResult importPlantusDB(AdminAreaViewModels.UtilsViewModel utilsViewModel)
        {
            //importPlantusDB();
            return RedirectToAction("Index");
        }
        ...
        private void importPlantusDB()
        {
            ...
            TaxonomicTree plantusRootNode = (from t in ctx.TaxonomicTree where t.Id == plantusTreeRootId select t).FirstOrDefault();
            ...
            while ((line = file.ReadLine()) != null)
            {
                ...
                else
                {
                    ...
                    ctx.TaxonomicTree.Add(subphylum);
                    ctx.SaveChanges();
                }
                ...
                else
                {
                    ...
                    ctx.TaxonomicTree.Add(classTaxon);
                    ctx.SaveChanges();
                }
                ...
                else
                {
                    ...
                    ctx.TaxonomicTree.Add(subclass);
                    ctx.SaveChanges();
                }
                ...
                ctx.PlantCharacteristic.Add(pc);
